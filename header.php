...
<head>
    ...
    <style>
        :root {
            --primary-color: #<?php echo $setting_data['theme_color'] ?>;
            --secondary-color: #<?php echo $setting_data['theme_color'] ?>;

            --btn-primary-border-radius: 0.25rem;
            --btn-primary-color: #fff;
            --btn-primary-background-color: #<?php echo $setting_data['theme_color'] ?>;
            --btn-primary-border-color: #<?php echo $setting_data['theme_color'] ?>;
            --btn-primary-hover-color: #fff;
            --btn-primary-background-hover-color: #<?php echo $setting_data['theme_color'] ?>;
            --btn-primary-border-hover-color: #<?php echo $setting_data['theme_color'] ?>;
            --btn-primary-font-weight: 500;

            --btn-secondary-border-radius: 0.25rem;
            --btn-secondary-color: #<?php echo $setting_data['theme_color'] ?>;
            --btn-secondary-background-color: transparent;
            --btn-secondary-border-color: #<?php echo $setting_data['theme_color'] ?>;
            --btn-secondary-hover-color: #fff;
            --btn-secondary-background-hover-color: #<?php echo $setting_data['theme_color'] ?>;
            --btn-secondary-border-hover-color: #<?php echo $setting_data['theme_color'] ?>;
                        ...
                        <div class="col-lg-6 d-lg-block d-none">
                            <nav class="site-navigation">
                                <ul class="main-menu list-unstyled justify-content-center">
                                    ...
                                    <li class="menu-list-item nav-item <?php if ($cur_page == 'contact.php') {
                                                                            echo 'active';
                                                                        } ?>">
                                        <a class="nav-link" href="<?php echo BASE_URL; ?>contact">Contact</a>
                                    </li>
                                    <li class="menu-list-item nav-item <?php if ($cur_page == 'tracking.php') {
                                                                            echo 'active';
                                                                        } ?>">
