                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="product_category_id" class="form-select">
                                                ...
                                                ?>
                                                    <option value="<?php echo $row['id']; ?>" <?php if (isset($_POST['product_category_id']) && $_POST['product_category_id'] == $row['id']) {
                                                                                                    echo 'selected';
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="quantity" value="<?php if (isset($_POST['quantity'])) {
                                                                                                                echo $_POST['quantity'];
                                                                                                            } ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="regular_price" value="<?php if (isset($_POST['regular_price'])) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="sale_price" value="<?php if (isset($_POST['sale_price'])) {
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="short_description" class="form-control h_100" value="<?php if (isset($_POST['short_description'])) {
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="description" class="form-control editor" value="<?php if (isset($_POST['description'])) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label>Size</label>
                                            <input type="text" class="form-control" name="size" value="<?php if (isset($_POST['size'])) {
                                                                                                            echo $_POST['size'];
                                                                                                        } ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="water_resistant" class="form-select">
                                                <option value="Yes" <?php if (isset($_POST['water_resistant']) && $_POST['water_resistant'] == 'Yes') {
                                                                        echo 'selected';
                                                                    } ?>>Yes</option>
                                                <option value="No" <?php if (isset($_POST['water_resistant']) && $_POST['water_resistant'] == 'No') {
                                                                        echo 'selected';
                                                                    } ?>>No</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="warranty" value="<?php if (isset($_POST['warranty'])) {
                                                                                                                echo $_POST['warranty'];
                                                                                                            } ?>">
                                        </div>
                                    </div>
