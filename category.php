...
<?php
$statement = $pdo->prepare("SELECT * FROM post_categories WHERE slug=?");
...
<div class="breadcrumb">
    <div class="container">
        <ul class="list-unstyled d-flex align-items-center m-0">
            ...
            <li>Category: <?php echo $category_data['name']; ?></li>
        </ul>
    </div>
</div>
<!-- breadcrumb end -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    $statement = $pdo->prepare("SELECT p.*, pc.name AS post_category_name 
                                    ...
                                    ORDER BY p.id DESC
                                ");
                    $statement->execute([$category_data['id']]);
                    ...
                    <div class="pagination justify-content-center mt-100">
                        <nav>
                            <ul class="pagination m-0 d-flex align-items-center">
                                ...
                                <?php
                                $common_url = BASE_URL . 'category/' . $_REQUEST['slug'];
                                if (isset($_REQUEST['p'])) {
                                    if ($_REQUEST['p'] == 1) {
                                ?>
                                        <li class="item">
                                    ...
                                    ?>
                                        <li class="item">
                                            <a class="link" href="<?php echo $common_url; ?>/<?php echo $_REQUEST['p'] - 1; ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="icon icon-left">
                                ...
                                ?>
                                    <li class="item"><a class="link" href="<?php echo $common_url; ?>/<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                <?php
                                }
                                ?>
                                ...
                                ?>
                                    ...
                                    ?>
                                    <li class="item">
                                        <a class="link" href="<?php echo $common_url; ?>/2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="icon icon-right">
