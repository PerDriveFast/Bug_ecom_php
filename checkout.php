                        ...
                        <form action="" method="post">
                            <div class="shipping-address-area">
                                ...
                                <div class="shipping-address-form-wrapper">
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            <input type="text" class="form-control" placeholder="Name" name="name" value="<?php if (isset($_SESSION['customer'])) {
                                                                                                                                echo $_SESSION['customer']['name'];
                                                                                                                            } ?>">
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <input type="text" class="form-control" placeholder="Email" name="email" value="<?php if (isset($_SESSION['customer'])) {
                                                                                                                                echo $_SESSION['customer']['email'];
                                                                                                                            } ?>">
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <input type="text" class="form-control" placeholder="Phone" name="phone" value="<?php if (isset($_SESSION['customer'])) {
                                                                                                                                echo $_SESSION['customer']['phone'];
                                                                                                                            } ?>">
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <input type="text" class="form-control" placeholder="Address" name="address" value="<?php if (isset($_SESSION['customer'])) {
